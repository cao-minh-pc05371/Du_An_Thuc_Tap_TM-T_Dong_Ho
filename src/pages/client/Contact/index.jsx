...
function Contact() {
    ...
    return (
        <main class="w-[80%] mx-auto p-8 bg-white shadow-lg rounded-lg my-[20px] " >
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
                <section class="lg:p-4 p-2 py-1">
                    <h2 class=" text-2xl font-bold text-blue-950 pb-3">Câu hỏi thường gặp</h2>
                ...
                <section class="p-2 lg:p-4">
                    <h2 class="text-2xl font-bold text-blue-950 pb-3">Liên hệ hỗ trợ</h2>
                    <hr className="border-gray-400 border-2 my-2" />
            ...
            ${errors.message ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-500'}`}
                        ...
                        <button
                            type="submit"
                            className="w-full !bg-green-900 text-white py-2 rounded hover:bg-green-950 font-semibold"
                        >
                            Gửi yêu cầu
                        </button>
                    </form>
            ...
            <section class="mt-8 text-gray-800 text-center border-t border-gray-300">
                <h2 class="text-3xl font-bold text-green-950 mb-6 mt-8 pb-2">Thông tin liên hệ</h2>
                <iframe
